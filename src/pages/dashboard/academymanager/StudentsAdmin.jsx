...
import { getStudentsByAcademy, getUserById } from "../../../utils/auth";
...
export default function StudentsAdmin() {
    ...
    const fetchStudents = async () => {
      ...
      try {
        ...
        if (data && Array.isArray(data)) {
          const studentsWithGroups = data.map(student => ({
            ...student,
            groupNames: student.groups?.map(g => g.name) || []
          }));
  ...
  const handleShowDetails = async (studentId) => {
    ...
    try {
      const details = await getUserById(studentId);
                ...
                <div className="p-6">
                  {detailsLoading ? (
                    <div className="flex items-center justify-center py-12">
                      <div className="text-blue-600">Loading student details...</div>
                    </div>
                  ) : studentDetails ? (
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div className="bg-gray-50 p-4 rounded-lg">
                            ...
                            <p className="font-medium text-gray-900 flex items-center">
                              ...
                              {studentDetails.account?.email || 'N/A'}
                            </p>
                          </div>
                          <div className="bg-gray-50 p-4 rounded-lg">
                            <label className="text-sm text-gray-500">Student ID</label>
                            <p className="font-medium text-gray-900">#{studentDetails.id}</p>
                          </div>
                          <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          {studentDetails.groups?.map((group, index) => (
                      ...
                      {studentDetails.userGroup && studentDetails.userGroup.length > 0 && (
                        <div>
                          <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                          ...
                          <div className="space-y-3">
                            {studentDetails.userGroup.map((userGroup, index) => (
